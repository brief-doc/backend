    ...
    try:
        ...
        for col in client.list_collections():
            ...
            if total:
                ...
                print(f"  샘플 내용: {(data['documents'][0] if data['documents'] else '')[:100]}...")
...
if __name__ == "__main__":
    ...
    if cmd in ("chromadb", "all"): print("=== ChromaDB ==="); check_chromadb()
    if cmd in ("db",       "all"): print("\n=== DB Config ==="); check_db_config()
    if cmd in ("routes",   "all"): print("\n=== Routes ==="); check_routes()
